...
class TestGetKendallCoef:
    ...
    def test_get_kendall_coef_various_sizes(self):
        ...
        assert (
            result_95_10 > result_95_4
        )  # Larger sample should have larger coefficient
...
class TestMannKendall:
    ...
    def test_mann_kendall_structure(
        self, mock_image_collection_class, mock_image_class
    ):
        ...
        assert (
            mock_image_collection_class.call_count == 2
        )  # Called for concordant and discordant arrays

    @patch("ee.Image")
    @patch("ee.ImageCollection")
    def test_mann_kendall_with_different_sizes(
        self, mock_image_collection_class, mock_image_class
    ):
    ...
    @patch("ee.Image")
    @patch("ee.ImageCollection")
    def test_mann_kendall_pairwise_comparisons(
        self, mock_image_collection_class, mock_image_class
    ):
